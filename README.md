...
In depth articles on conformance to / divergence from the spec:

- [XQuery in BaseX](http://docs.basex.org/wiki/XQuery)
- [XQuery in eXist-db](http://exist-db.org/exist/apps/doc/xquery.xml)
- [XQuery in MarkLogic](https://docs.marklogic.com/guide/xquery)
